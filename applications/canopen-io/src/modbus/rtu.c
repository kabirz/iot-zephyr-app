 ...
 * (移植自 io-edge-hub src/modbus/rtu.c, 原样保留)
 *
...
/* priority 13: 在 settings load (8) 之后, 拿到持久化的 baud/slave_id */
SYS_INIT(rtu_init, APPLICATION, CONFIG_CANOPEN_IO_INIT_PRIORITY_RTU);
